...
function getUserDisplayEle(user) {
    return `<div class="user-display-ele">
        ...
        <div class="edit-view">
            ...
            <div>
                First name: <input class="first-name-edit-input" value="${user.first_name || ''}">
            </div>
            <div>
                Last name: <input class="last-name-edit-input" value="${user.last_name || ''}">
            </div>
...
function submitEdit(ele) {
    ...
    var firstNameInput = userEle.getElementsByClassName('first-name-edit-input')[0];
    var lastNameInput = userEle.getElementsByClassName('last-name-edit-input')[0];
